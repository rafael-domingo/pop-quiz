export const Quiz = {
    ...
    generateQuiz(topArtists, topTracks, topLyrics) {
        var quizArray = []
        if (topArtists.length !== undefined && topTracks.length !== undefined) {
        ...
        if (topLyrics.length !== undefined) {
            ...
            while (lyricsUndefined1) {
                ...
                if (topLyrics[randIndex25].snippet_body !== "" || topLyrics[randIndex25] !== undefined) {
                    questionObject = {
            ...
            while (lyricsUndefined2) {
                ...
                if (topLyrics[randIndex27].snippet_body !== "" || topLyrics[randIndex27] !== undefined) {
                    questionObject = {
                        question: 'Which track has this lyric?',
            ...
            while (lyricsUndefined3) {
                ...
                if (topLyrics[randIndex29].snippet_body !== "" || topLyrics[randIndex29] !== undefined) {
                    questionObject = {
                        question: 'Which track has this lyric?',
            ...
            while (lyricsUndefined4) {
                ...
                if (topLyrics[randIndex31].snippet_body !== "" || topLyrics[randIndex31] !== undefined) {
                    questionObject = {
                        question: 'Which track has this lyric?',
            ...
            while (lyricsUndefined5) {
                ...
                if (topLyrics[randIndex33].snippet_body !== "" || topLyrics[randIndex33] !== undefined) {
                    questionObject = {
                        question: 'Which track has this lyric?',
